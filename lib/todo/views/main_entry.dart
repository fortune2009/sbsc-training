...
import 'package:todo_app/todo/model/gridview_model.dart';

class AllTodoList extends StatefulWidget {
  final category;
  final categoryColor;

  AllTodoList({Key key, this.category, this.categoryColor}) : super(key: key);
  @override
  _AllTodoListState createState() => _AllTodoListState();
}
